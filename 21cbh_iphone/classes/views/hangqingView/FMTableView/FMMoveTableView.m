...
- (UIView *)snapShotFromRowAtMovingIndexPath
{
    ...
    if (kDeviceVersion>=7) {
        ...
        UIView *vv = [[UIView alloc] initWithFrame:CGRectMake(0, 0, snapShot.frame.size.width, snapShot.frame.size.height)];
        vv.backgroundColor = UIColorFromRGB(0x262626);
        vv.alpha = 0.5;
        [snapShot addSubview:vv];
        vv = nil;
        ...
        CGRect snapShotFrame = [self rectForRowAtIndexPath:self.movingIndexPath];
        snapShotFrame.size = cellFrame.size;
        snapShotOfMovingCell.backgroundColor = UIColorFromRGB(0x262626);
