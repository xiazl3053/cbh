...
- (id)initWithNamespace:(NSString *)ns {
    if ((self = [super init])) {
       //NSString *fullNamespace = [@"com.hackemist.SDWebImageCache." stringByAppendingString:ns];
        NSString *fullNamespace=kImageCachePath;
...
- (NSString *)myCachedNameForUrl:(NSString *)url {
...
//    NSString* str=[self myCachedForKey:key];
//    NSData *localData = [NSData dataWithContentsOfFile:str];
//    if(localData){
//        return localData;
//    }
